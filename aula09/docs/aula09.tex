% Parâmetros documentclass:
% [t] - Alinha o conteúdo no topo dos slides
% [aspectratio=169] - Define proporção de tela em 16:9
% [draft] - Modo rascunho (não compila imagens, acelera compilação)
% [handout] - Formato para impressão (múltiplos slides por página)
% {beamer} - Classe para criação de apresentações
